...
from ospd_openvas.messages.status import ScanStatusMessage, ScanStatus
...
class NotusHandler:
    ...
    def __init__(
        ...
        status_func: Callable[[str, str, ScanStatus], None],
    ) -> None:
        self._results = {}
    ...
    def status_handler(self, stat_msg: ScanStatusMessage):
        self._status_func(stat_msg.scan_id, stat_msg.host_ip, stat_msg.status)
